 ...
 */
let estudiantes = ["Raul","Mafer","Athziry","Jiram","Pepe"]
let sortedCollection1 = estudiantes.sorted(by: forward)
 ...
 */
let sortedCollection2 = estudiantes.sorted{(name1, name2)-> Bool in
    return name1 < name2
 ...
 */
let sortedCollection3 = estudiantes.sorted(by:<)
